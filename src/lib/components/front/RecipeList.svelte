<script lang="ts">
  ...
  let { recipes, pagination, listTitle }: { recipes: PartialRecipe[]; pagination: PaginationType; listTitle?: string } = $props();
...
<svelte:head>
  ...
  <meta property="og:title" content={title(listTitle)} />
...
<main class="main-content">
  ...
  <div class="recipe-grid">
    ...
    {/each}
    {#if !recipes.length}
      <h5 class="text-center font-bold text-2xl col-span-3">Nessun risultato trovato :(</h5>
    {/if}
  </div>
